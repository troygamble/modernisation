	...
	<div class="deck-wide" style="text-align: center;">
		...
		<div class="commercial-flow" style="text-align: left; margin-top: 32px;">
			<div class="flow-card">
				...
				<div class="flow-card-text">Use our own business as the proving ground. Document repeatable patterns.</div>
			</div>
			...
			<div class="flow-card">
				...
				<div class="flow-card-text">Create a high-margin Professional Services offering for our 1,800 contacts.</div>
			</div>
			<div class="flow-arrow-large">→</div>
			<div class="flow-card accent">
				...
				<div class="flow-card-text">Unlock a potential ~$700k revenue stream and cement brand leadership.</div>
			</div>
		</div>
	</div>
</section>
