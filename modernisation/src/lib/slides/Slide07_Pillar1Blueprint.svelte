			...
			<div class="two-col">
				<div class="col">
					...
					<ul class="pill-list">
						...
						<li class="pill"><span class="pill-strong">Scope & Change Control:</span> A zero-tolerance financial process for scope creep.</li>
				...
				<div class="col">
					...
					<ul class="pill-list">
						...
						<li class="pill"><span class="pill-strong">Meeting Agendas:</span> Standardised outcomes, actions, and minutes for all delivery meetings.</li>
